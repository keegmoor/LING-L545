# -*- coding: utf-8 -*-
"""Model_Creator_GPU.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13Xs2yBtmc3xj4bUN_tKHYnWiNNYY9yjd

This notebook is built off of the tutorial by Lynn Zheng here https://www.freecodecamp.org/news/discord-ai-chatbot/ . It was then modified for the use of sounding like books rather than characters.
...
def train(args, train_dataset, model: PreTrainedModel, tokenizer: PreTrainedTokenizer) -> Tuple[int, float]:
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            tot_to+= sys.getsizeof(inputs)*8/1000000
            tot_to+= sys.getsizeof(labels)*8/1000000
...
def main(df_trn, df_val):
    ...
    tot_to+= sys.getsizeof(model)*8/1000000
...
for step in range(10):
    ...
    if tokenizer.decode(chat_history_ids[:, bot_input_ids.shape[-1]:][0], skip_special_tokens=True) in data['line']:
      print('directly from book.')
...
!git config --global user.email "keegmoor@iu.edu"
# Tip: using the same email as your huggingface.co account will link your commits to your profile
!git config --global user.name "keeg8"

MY_MODEL_NAME = 'Book-1700-1850'
HUGGINGFACE_API_KEY = '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'
